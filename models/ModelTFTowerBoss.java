...
@OnlyIn(Dist.CLIENT)
public static class ModelTFTowerBoss extends ModelTFGhast<EntityTFUrGhast> {
	...
	@Override
	public void setRotationAngles(EntityTFUrGhast entity, float limbSwing, float limbSwingAmount, float ageInTicks,
