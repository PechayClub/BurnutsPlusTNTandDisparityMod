...
package net.burnutsplus.tnt_and_disparity.particle;
...
public class EkorParticlesParticle {
	...
	public static void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("ekor_particles"));
	}
