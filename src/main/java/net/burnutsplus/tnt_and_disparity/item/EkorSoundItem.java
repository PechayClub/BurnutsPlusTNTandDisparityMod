...
public class EkorSoundItem extends TntAndDisparityModElements.ModElement {
	@ObjectHolder("tnt_and_disparity:ekor_sound")
	public static final Item block = null;
	public EkorSoundItem(TntAndDisparityModElements instance) {
		super(instance, 40);
	}
