...
import net.burnutsplus.tnt_and_disparity.entity.renderer.ShootableBBBRenderer;
...
public class ShootableBBBItem extends TntAndDisparityModElements.ModElement {
	@ObjectHolder("tnt_and_disparity:shootable_bbb")
	...
	public ShootableBBBItem(TntAndDisparityModElements instance) {
		super(instance, 6);
