...
public class RemoteBBBItem extends TntAndDisparityModElements.ModElement {
	@ObjectHolder("tnt_and_disparity:remote_bbb")
	public static final Item block = null;
	public RemoteBBBItem(TntAndDisparityModElements instance) {
		super(instance, 3);
	}
