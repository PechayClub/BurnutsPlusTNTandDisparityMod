...
public class GlueWaterBlock extends TntAndDisparityModElements.ModElement {
	@ObjectHolder("tnt_and_disparity:glue_water")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("tnt_and_disparity:glue_water_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public GlueWaterBlock(TntAndDisparityModElements instance) {
		super(instance, 17);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tnt_and_disparity:glue_water_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
