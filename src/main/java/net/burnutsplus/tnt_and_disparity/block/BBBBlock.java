...
import net.burnutsplus.tnt_and_disparity.procedures.BBBExplodeProcedure;
...
public class BBBBlock extends TntAndDisparityModElements.ModElement {
	@ObjectHolder("tnt_and_disparity:bbb")
	public static final Block block = null;
	@ObjectHolder("tnt_and_disparity:bbb")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BBBBlock(TntAndDisparityModElements instance) {
		super(instance, 1);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("bbb"));
		}
	}

	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.TNT).sound(SoundType.GROUND).hardnessAndResistance(80f, 11f).setLightLevel(s -> 0).harvestLevel(8)
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Be careful of this block."));
		}
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				{
					...
					BBBExplodeProcedure.executeProcedure($_dependencies);
				}
			} else {
				{
					Map<String, Object> $_dependencies = new HashMap<>();
