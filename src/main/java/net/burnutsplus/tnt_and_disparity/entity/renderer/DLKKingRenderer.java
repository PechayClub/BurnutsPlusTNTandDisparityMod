...
public class DLKKingRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DLKKingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDLKKingModel(), 0.9f) {
					@Override
	...
	public static class ModelDLKKingModel extends EntityModel<Entity> {
