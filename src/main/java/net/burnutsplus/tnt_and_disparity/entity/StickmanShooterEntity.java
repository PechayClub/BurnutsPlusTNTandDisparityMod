...
import net.burnutsplus.tnt_and_disparity.entity.renderer.StickmanShooterRenderer;
import net.burnutsplus.tnt_and_disparity.TntAndDisparityModElements;

@TntAndDisparityModElements.ModElement.Tag
public class StickmanShooterEntity extends TntAndDisparityModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.4f)).build("stickman_shooter").setRegistryName("stickman_shooter");
	public StickmanShooterEntity(TntAndDisparityModElements instance) {
		super(instance, 33);
