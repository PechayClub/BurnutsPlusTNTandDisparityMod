...
public class TntAndDisparityModElements {
	...
	public TntAndDisparityModElements() {
		...
		sounds.put(new ResourceLocation("tnt_and_disparity", "dlkkingstickman"),
				new net.minecraft.util.SoundEvent(new ResourceLocation("tnt_and_disparity", "dlkkingstickman")));
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == TntAndDisparityModElements.ModElement.class)
						elements.add((TntAndDisparityModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(TntAndDisparityModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new TntAndDisparityModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		TntAndDisparityMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final TntAndDisparityModElements elements;
		protected final int sortid;
		public ModElement(TntAndDisparityModElements elements, int sortid) {
