...
public class DLKCastleFeature extends Feature<NoneFeatureConfiguration> {
	public static final DLKCastleFeature FEATURE = (DLKCastleFeature) new DLKCastleFeature().setRegistryName("tnt_and_disparity:dlk_castle");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public DLKCastleFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("tnt_and_disparity", "dlk_castle"));
		if (template == null)
			return false;
