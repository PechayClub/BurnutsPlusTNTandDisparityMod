...
public class CarminiteBaseFeature extends Feature<NoneFeatureConfiguration> {
	public static final CarminiteBaseFeature FEATURE = (CarminiteBaseFeature) new CarminiteBaseFeature()
			.setRegistryName("tnt_and_disparity:carminite_base");
