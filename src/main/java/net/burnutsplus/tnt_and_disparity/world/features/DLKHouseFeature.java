...
package net.burnutsplus.tnt_and_disparity.world.features;
...
public class DLKHouseFeature extends Feature<NoneFeatureConfiguration> {
	public static final DLKHouseFeature FEATURE = (DLKHouseFeature) new DLKHouseFeature().setRegistryName("tnt_and_disparity:dlk_house");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private final List<Block> base_blocks = List.of(Blocks.VOID_AIR, Blocks.CAVE_AIR, Blocks.WATER, Blocks.LAVA, TntAndDisparityModBlocks.GLUE);
	private StructureTemplate template = null;

	public DLKHouseFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("tnt_and_disparity", "dlk_house"));
		if (template == null)
			return false;
