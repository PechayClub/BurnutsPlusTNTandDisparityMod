...
package net.burnutsplus.tnt_and_disparity.world.dimension;
...
public class DLKLandDimension extends TntAndDisparityModElements.ModElement {
	@ObjectHolder("tnt_and_disparity:dlk_land_portal")
	public static final CustomPortalBlock portal = null;
	public DLKLandDimension(TntAndDisparityModElements instance) {
		super(instance, 21);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("tnt_and_disparity:dlk_land"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("tnt_and_disparity:dlk_land"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("tnt_and_disparity:dlk_land")));
				} else {
					entity.func_242279_ag();
