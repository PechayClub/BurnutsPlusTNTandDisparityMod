...
public class CarminiteBaseRareStructure extends TntAndDisparityModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public CarminiteBaseRareStructure(TntAndDisparityModElements instance) {
		super(instance, 62);
