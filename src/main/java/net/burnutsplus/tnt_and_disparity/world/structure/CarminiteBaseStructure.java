...
public class CarminiteBaseStructure extends TntAndDisparityModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public CarminiteBaseStructure(TntAndDisparityModElements instance) {
		super(instance, 61);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new Feature<NoFeatureConfig>(NoFeatureConfig.field_236558_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
					...
					if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("twilightforest:twilightforest")))
						dimensionCriteria = true;
			...
			event.getRegistry().register(feature.setRegistryName("carminite_base"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tnt_and_disparity:carminite_base"), configuredFeature);
		}
	}
	@SubscribeEvent
