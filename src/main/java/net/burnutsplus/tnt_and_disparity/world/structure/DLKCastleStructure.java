...
public class DLKCastleStructure extends TntAndDisparityModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("dlk_castle"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tnt_and_disparity:dlk_castle"), configuredFeature);
		}
	}
	@SubscribeEvent
