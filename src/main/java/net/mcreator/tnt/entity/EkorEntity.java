...
import net.mcreator.tnt.item.EkorShooterItem;
import net.mcreator.tnt.entity.renderer.EkorRenderer;
...
public class EkorEntity extends TntModElements.ModElement {
	...
	public EkorEntity(TntModElements instance) {
		super(instance, 41);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("ekor_spawn_egg"));
	}
