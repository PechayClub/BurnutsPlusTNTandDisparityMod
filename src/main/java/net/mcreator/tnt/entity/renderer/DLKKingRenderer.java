...
import net.mcreator.tnt.entity.DLKKingEntity;
	...
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DLKKingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelDLKKing(), 0.9f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("tnt:textures/dlkking.png");
					}
				};
			});
		}
