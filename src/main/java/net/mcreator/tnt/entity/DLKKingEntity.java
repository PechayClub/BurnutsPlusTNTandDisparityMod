...
import net.mcreator.tnt.procedures.DLKKingOnInitialEntitySpawnProcedure;
import net.mcreator.tnt.procedures.DLKKingOnEntityTickUpdateProcedure;
import net.mcreator.tnt.procedures.DLKKingEntityDiesProcedure;
import net.mcreator.tnt.procedures.DLKItIsStruckByLightningProcedure;
import net.mcreator.tnt.entity.renderer.DLKKingRenderer;
...
public class DLKKingEntity extends TntModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("dlk_king").setRegistryName("dlk_king");
	public DLKKingEntity(TntModElements instance) {
		super(instance, 36);
