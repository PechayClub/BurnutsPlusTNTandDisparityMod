...
import net.mcreator.tnt.entity.renderer.StickmanRenderer;
...
public class StickmanEntity extends TntModElements.ModElement {
	...
	public StickmanEntity(TntModElements instance) {
		super(instance, 26);
		FMLJavaModLoadingContext.get().getModEventBus().register(new StickmanRenderer.ModelRegisterHandler());
