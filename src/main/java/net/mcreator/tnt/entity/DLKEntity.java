...
import net.mcreator.tnt.procedures.DLKEntityDiesProcedure;
import net.mcreator.tnt.entity.renderer.DLKRenderer;
...
public class DLKEntity extends TntModElements.ModElement {
	...
	public DLKEntity(TntModElements instance) {
		super(instance, 14);
