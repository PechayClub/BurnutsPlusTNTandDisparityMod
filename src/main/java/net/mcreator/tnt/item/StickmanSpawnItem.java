...
import net.mcreator.tnt.procedures.StickmanSpawnRightClickedOnBlockProcedure;
...
public class StickmanSpawnItem extends TntModElements.ModElement {
	@ObjectHolder("tnt:stickman_spawn")
	public static final Item block = null;
	public StickmanSpawnItem(TntModElements instance) {
		super(instance, 35);
	}
