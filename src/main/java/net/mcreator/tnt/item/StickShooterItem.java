...
public class StickShooterItem extends TntModElements.ModElement {
	@ObjectHolder("tnt:stick_shooter")
	public static final Item block = null;
	@ObjectHolder("tnt:entitybulletstick_shooter")
	public static final EntityType arrow = null;
	public StickShooterItem(TntModElements instance) {
		super(instance, 34);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletstick_shooter").setRegistryName("entitybulletstick_shooter"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 10f, 20, 0);
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("tnt:textures/stickman.png");
