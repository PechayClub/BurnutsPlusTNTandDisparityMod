...
import net.mcreator.tnt.entity.renderer.StickShooterRenderer;
...
public class StickShooterItem extends TntModElements.ModElement {
	...
	public StickShooterItem(TntModElements instance) {
		super(instance, 34);
		FMLJavaModLoadingContext.get().getModEventBus().register(new StickShooterRenderer.ModelRegisterHandler());
	}
