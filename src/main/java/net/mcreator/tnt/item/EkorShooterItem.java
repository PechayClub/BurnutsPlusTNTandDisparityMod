...
import net.mcreator.tnt.procedures.EkorShooterBulletHitsPlayerProcedure;
import net.mcreator.tnt.entity.renderer.EkorShooterRenderer;
...
public class EkorShooterItem extends TntModElements.ModElement {
	@ObjectHolder("tnt:ekor_shooter")
	...
	public EkorShooterItem(TntModElements instance) {
		super(instance, 39);
