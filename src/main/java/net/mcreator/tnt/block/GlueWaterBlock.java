...
import net.mcreator.tnt.procedures.GlueWaterUpdateTickProcedure;
...
public class GlueWaterBlock extends TntModElements.ModElement {
	@ObjectHolder("tnt:glue_water")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("tnt:glue_water_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public GlueWaterBlock(TntModElements instance) {
		super(instance, 17);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("tnt:blocks/gluewater"), new ResourceLocation("tnt:blocks/gluewater")).luminosity(0)
						.density(100000).viscosity(100000)).bucket(() -> bucket).block(() -> block);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("glue_water_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tnt:glue_water_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
