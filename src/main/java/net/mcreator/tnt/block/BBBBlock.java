...
import net.mcreator.tnt.procedures.BBBExplodeProcedure;
...
public class BBBBlock extends TntModElements.ModElement {
	@ObjectHolder("tnt:bbb")
	public static final Block block = null;
	@ObjectHolder("tnt:bbb")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BBBBlock(TntModElements instance) {
		super(instance, 1);
