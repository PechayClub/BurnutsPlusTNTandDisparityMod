...
package net.mcreator.tnt.world.dimension;
...
import net.mcreator.tnt.item.DLKLandItem;
import net.mcreator.tnt.block.DLKLandPortalFrameBlock;
...
public class DLKLandDimension extends TntModElements.ModElement {
	@ObjectHolder("tnt:dlk_land_portal")
	public static final CustomPortalBlock portal = null;
	public DLKLandDimension(TntModElements instance) {
		super(instance, 21);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("tnt:dlk_land"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("dlk_land_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("dlk_land_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
	...
	public void initElements() {
		...
		elements.items.add(() -> new DLKLandItem().setRegistryName("dlk_land"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				...
				} else if (entity.world.getDimensionKey() != RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("tnt:dlk_land"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("tnt:dlk_land")));
				} else {
					entity.func_242279_ag();
