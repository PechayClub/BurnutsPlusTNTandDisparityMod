...
public class StickmanEntity extends PathfinderMob {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, FlyingMob.class, false, false));
		this.goalSelector.addGoal(9, new FloatGoal(this));
		this.goalSelector.addGoal(10, new LeapAtTargetGoal(this, (float) 2));
