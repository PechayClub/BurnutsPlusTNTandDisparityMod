...
import ch.teamburnuts.tnt_and_disparity.procedures.DLKKingOnInitialEntitySpawnProcedure;
import ch.teamburnuts.tnt_and_disparity.procedures.DLKKingItIsStruckByLightningProcedure;
import ch.teamburnuts.tnt_and_disparity.procedures.DLKKingEntityIsHurtProcedure;
import ch.teamburnuts.tnt_and_disparity.procedures.DLKKingEntityDiesProcedure;
import ch.teamburnuts.tnt_and_disparity.init.TntAndDisparityModEntities;

public class DLKKingEntity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.WHITE,
			ServerBossEvent.BossBarOverlay.PROGRESS);

	public DLKKingEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(TntAndDisparityModEntities.DLK_KING, world);
	}

	public DLKKingEntity(EntityType<DLKKingEntity> type, Level world) {
		super(type, world);
		xpReward = 1000;
		setNoAi(false);
	...
	public void thunderHit(ServerLevel serverWorld, LightningBolt lightningBolt) {
		...
		DLKKingItIsStruckByLightningProcedure.execute(world, x, y, z, entity);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		...
		DLKKingEntityIsHurtProcedure.execute(world, x, y, z);
	...
	public void die(DamageSource source) {
		...
		DLKKingEntityDiesProcedure.execute(world, x, y, z, entity);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		DLKKingOnInitialEntitySpawnProcedure.execute(world, x, y, z);
		return retval;
	}
