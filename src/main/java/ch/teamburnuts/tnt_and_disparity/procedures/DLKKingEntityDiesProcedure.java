...
public class DLKKingEntityDiesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
			...
			if (mcserv != null)
				mcserv.getPlayerList()
						.broadcastMessage(new TextComponent(
								("<" + new TranslatableComponent("entity.tnt_and_disparity.dlk_king").getString() + "> " + "NOOOOOOOOOOOOOOO!!!")),
		...
		if (entity instanceof ServerPlayer _player) {
			Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("tnt_and_disparity:dlk_in_the_trash"));
