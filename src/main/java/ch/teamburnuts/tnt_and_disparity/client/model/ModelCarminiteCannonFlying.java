...
public class ModelCarminiteCannonFlying<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("tnt_and_disparity", "model_carminite_cannon_flying"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone4 = partdefinition.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 3).addBox(-8.0F, -18.0F, -8.0F, 16.0F, 5.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 3)
		...
		PartDefinition cube_r1 = bone4.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-20.0F, 3.0F, -1.0F, 40.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone3 = partdefinition.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(30, 27).addBox(-4.0F, 4.0F, -2.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 10)
		...
		PartDefinition bone2 = partdefinition.addOrReplaceChild(
				"bone2", CubeListBuilder.create().texOffs(0, 24).addBox(4.0F, -3.0F, -9.0F, 6.0F, 6.0F, 18.0F, new CubeDeformation(0.0F))
						.texOffs(0, 24).addBox(-10.0F, -3.0F, -9.0F, 6.0F, 6.0F, 18.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 17.0F, 0.0F));
		PartDefinition bone = partdefinition.addOrReplaceChild(
				"bone", CubeListBuilder.create().texOffs(8, 10).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(30, 24).addBox(-7.0F, -1.0F, -1.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(13.0F, 7.0F, -13.0F));
		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(30, 24).addBox(-7.0F, -1.0F, -1.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition bone5 = partdefinition.addOrReplaceChild(
				"bone5", CubeListBuilder.create().texOffs(8, 10).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(30, 24).addBox(-7.0F, -1.0F, -1.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(13.0F, 7.0F, 13.0F));
		PartDefinition cube_r4 = bone5.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(30, 24).addBox(-7.0F, -1.0F, -1.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition bone6 = partdefinition.addOrReplaceChild(
				"bone6", CubeListBuilder.create().texOffs(8, 10).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(30, 24).addBox(-7.0F, -1.0F, -1.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-13.0F, 7.0F, 13.0F));
		PartDefinition cube_r5 = bone6.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(30, 24).addBox(-7.0F, -1.0F, -1.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition bone7 = partdefinition.addOrReplaceChild(
				"bone7", CubeListBuilder.create().texOffs(8, 10).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(30, 24).addBox(-7.0F, -1.0F, -1.0F, 14.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-13.0F, 7.0F, -13.0F));
